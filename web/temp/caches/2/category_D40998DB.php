...
<div class="nav dsc-zoom">
    ...
    <div class="hotsale w1390 w">
        ...
        <div class="bd">
            <ul>
            	                                <li>
                    <div class="item">
                        <div class="p-img"><a href="goods.php?id=708" target="_blank"><img src="images/201703/thumb_img/0_thumb_G_1490155421769.jpg" /></a></div>
                        <div class="p-name"><a href="goods.php?id=708" title="小米手环2蓝牙智能男女情侣运动计步器睡眠心率检测器手表支持IOS 精准心率监测 超长续航 触摸操作" target="_blank">小米手环2蓝牙智能男女情侣运动计步器睡眠心率检测器手表支持IOS 精准心率监测 超长续航 触摸操作</a></div>
                        <div class="p-price">
                        	                                <em>¥</em>149.00                                                    </div>
                        <div class="p-btn"><a class="btn sc-redBg-btn" href="goods.php?id=708">立即购买</a></div>
                    </div>
                </li>
                                            </ul>
	...
	<div class="crumbs-nav-main clearfix">
			...
			<div class="menu-drop">
				<div class="trigger">
					<a href="category.php?id=3"><span>手机、数码、通信</span></a>
					<i class="iconfont icon-down"></i>
				</div>
                				<div class="menu-drop-main">
					<ul>
												<li><a href="category.php?id=33">手机通讯</a></li>
												<li><a href="category.php?id=42">运营商</a></li>
												<li><a href="category.php?id=47">手机配件</a></li>
												<li><a href="category.php?id=64">摄影摄像</a></li>
												<li><a href="category.php?id=76">数码配件</a></li>
												<li><a href="category.php?id=99">时尚影音</a></li>
												<li><a href="category.php?id=112">智能设备</a></li>
											</ul>
				</div>
                			</div>
			...
			<div class="menu-drop">
				<div class="trigger">
					<a href="category.php?id=112"><span>智能设备</span></a>
					<i class="iconfont icon-down"></i>
				</div>
                				<div class="menu-drop-main">
					<ul>
												<li><a href="category.php?id=113">智能手环</a></li>
												<li><a href="category.php?id=114">智能手表</a></li>
												<li><a href="category.php?id=115">智能眼镜</a></li>
												<li><a href="category.php?id=116">运动跟踪器</a></li>
												<li><a href="category.php?id=117">健康监测</a></li>
												<li><a href="category.php?id=119">智能配饰</a></li>
												<li><a href="category.php?id=120">智能家居</a></li>
												<li><a href="category.php?id=122">体感车</a></li>
												<li><a href="category.php?id=124">其他配件</a></li>
											</ul>
				</div>
                			</div>
			<i class="iconfont icon-right"></i>		</div>
			...
			<div class="menu-drop">
				<div class="trigger bottom">
					<a href="category.php?id=113"><span>智能手环</span></a>
					<i class="iconfont icon-down"></i>
				</div>
                			</div>
					</div>
    ...
    <div class="u_cloose">
        <dl>
            ...
            <dd class="give_up_all"><a href="category.php?id=113" class="ftx-05">全部撤销</a></dd>
        </dl>
    </div>
		...
		<ul class="attr_father">
                ...
                <div class="s-l-wrap brand_img attr_list">
                    ...
                    <div class="s-l-value brand_select_more">
                        ...
                        <div class="wrap_brand">  
                            <div class="brand_div">
                                                                <div class="brand_img_word" brand ="K">
                                                                            <a href="category.php?id=113&amp;brand=154">
                                        	<img src="data/brandlogo/1490073529881448780.jpg" alt="匡威" title="匡威"> 
                                        	<span>匡威</span>
                                        </a>
                                                                    </div>
                                                            </div>
                        ...
                        <div class="zimu_list">
                            <ul class="get_more" >
                                                                <li class="is_no" brand ="K" url_id="154"><span class="choose_ico"></span><a class="goods_brand_name" data-url="category.php?id=113&amp;brand=154">匡威</a></li>
                                                            </ul>
                        </div>
    ...
    <div class="filter-sort">
        <a href="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list" class="curr">综合<i class="iconfont icon-arrow-down"></i></a>
        <a href="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume&order=DESC#goods_list" class="">销量<i class="iconfont icon-arrow-up"></i></a>
        <a href="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list" class="">新品<i class="iconfont icon-arrow-up"></i></a>
        <a href="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=comments_number&order=ASC#goods_list" class="">评论数<i class="iconfont icon-arrow-up"></i></a>
        <a href="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list" class="">价格<i class="iconfont icon-arrow-up"></i></a>
    </div>
    <div class="filter-range">
        ...
        <div class="fcheckbox">
                ...
                <div class="checkbox_item ">
                    ...
                    <i id="input-i1" rev="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&ship=1&self=0&have=0&sort=goods_id&order=DESC#goods_list"></i>
                    <i id="input-i2" rev="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&ship=0&self=0&have=0&sort=goods_id&order=DESC#goods_list"></i>
                </div>
                <div class="checkbox_item ">
                    ...
                    <i id="input-i1" rev="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&ship=0&self=1&have=0&sort=goods_id&order=DESC#goods_list"></i>
                    <i id="input-i2" rev="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&ship=0&self=0&have=0&sort=goods_id&order=DESC#goods_list"></i>
                </div>
                <div class="checkbox_item ">
                    ...
                    <i id="input-i1" rev="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&ship=0&self=0&have=1&sort=goods_id&order=DESC#goods_list"></i>
                    <i id="input-i2" rev="category.php?category=113&display=grid&brand=&ubrand=0&price_min=0&price_max=0&filter_attr=0&ship=0&self=0&have=0&sort=goods_id&order=DESC#goods_list"></i>
                </div>
            </div>
        </div>
...
<div class="g-view w">
                ...
                <ul ectype="items">
                        ...
                        <div class="gl-i-wrap">
                            <div class="p-img"><a href="goods.php?id=708" target="_blank"><img src="images/201703/thumb_img/0_thumb_G_1490155421769.jpg" /></a></div>
                                ...
                                <ul>
                                                                                                            <li  class="curr"><img src="images/201703/thumb_img/_thumb_P_1490155427216.jpg" width="26" height="26" /></li>
                                                                                                                                                <li ><img src="images/201703/thumb_img/_thumb_P_1490155427135.jpg" width="26" height="26" /></li>
                                                                                                                                                <li ><img src="images/201703/thumb_img/0_thumb_P_1490155421675.jpg" width="26" height="26" /></li>
                                                                                                        </ul>
                            ...
                            <div class="p-name"><a href="goods.php?id=708" title="小米手环2蓝牙智能男女情侣运动计步器睡眠心率检测器手表支持IOS 精准心率监测 超长续航 触摸操作" target="_blank">小米手环2蓝牙智能男女情侣运动计步器睡眠心率检测器手表支持IOS 精准心率监测 超长续航 触摸操作</a></div>
                            <div class="p-store">
                                                                <a href="merchants_store.php?merchant_id=2" title="绿联" class="store" target="_blank">绿联</a>
                                                                
                                                                <a href="javascript:;" id="IM" onclick="openWin(this)" ru_id="2" class="p-kefu"><i class="iconfont icon-kefu"></i></a>
                                ...
                                <a href="javascript:void(0);" id="compareLink">
                                    <input id="708" type="checkbox" name="duibi" class="ui-checkbox" onClick="Compare.add(this, 708,'小米手环2蓝牙智能男女情侣运动计步器睡眠心率检测器手表支持IOS 精准心率监测 超长续航 触摸操作','0', 'images/201703/thumb_img/0_thumb_G_1490155421769.jpg', '<em>¥</em>149.00', '<em>¥</em>178.79')">
                                    <label class="ui-label" for="708">对比</label>
                                </a>
                                <a href="javascript:collect(708);" class="choose-btn-coll"><i class="iconfont icon-zan-alt"></i>收藏</a>
                                                                                                        <a href="javascript:void(0);" onClick="javascript:addToCart(708,0,event,this,'flyItem');" rev="images/201703/thumb_img/0_thumb_G_1490155421769.jpg" data-dialog="addCart_dialog" data-divid="addCartLog" data-title="请选择属性" class="addcart">
            ...
            <ul ectype="items">
                    ...
                    <div class="gl-i-wrap">
                        ...
                        <div class="col col-4">
                            <div class="p-operate">
                                <a href="javascript:void(0);" id="compareLink">
                                <input id="duibi_708" type="checkbox" name="duibi" class="ui-checkbox" onClick="Compare.add(this, 708,'小米手环2蓝牙智能男女情侣运动计步器睡眠心率检测器手表支持IOS 精准心率监测 超长续航 触摸操作','0', 'images/201703/thumb_img/0_thumb_G_1490155421769.jpg', '<em>¥</em>149.00', '<em>¥</em>178.79')">
                                <label class="ui-label" for="duibi_708">对比</label>
                            </a>
                            <a href="javascript:collect(708);" class="choose-btn-coll"><i class="iconfont icon-zan-alt"></i>收藏</a>
                                                                                            <a href="javascript:void(0);" onClick="javascript:addToCart(708,0,event,this,'flyItem2');" rev="images/201703/thumb_img/0_thumb_G_1490155421769.jpg" data-dialog="addCart_dialog" data-id="" data-divid="addCartLog" data-url="" data-title="请选择属性" class="addcart">
                                    <i class="iconfont icon-carts"></i>加入购物车                                </a>
                                                                                        </div>
                        </div>
                    </div>
    ...
    <div class="gs-warp">
        ...
        <ul class="gs-list">
                ...
                <div class="">
                        <div class="p-img"><a href="goods.php?id=708" target="_blank"><img src="images/201703/thumb_img/0_thumb_G_1490155421769.jpg" width="190" height="190"></a></div>
                        <div class="p-price">
                                                    <em>¥</em>149.00                                                </div>
                    <div class="p-name"><a href="goods.php?id=708" target="_blank" title="小米手环2蓝牙智能男女情侣运动计步器睡眠心率检测器手表支持IOS 精准心率监测 超长续航 触摸操作">小米手环2蓝牙智能男女情侣运动计步器睡眠心率检测器手表支持IOS 精准心率监测 超长续航 触摸操作</a></div>
                    <div class="p-num">已售<em>0</em>件</div>
                </div>
            </li>
                    </ul>
