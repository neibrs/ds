...
<div class="catetop-main w w1200" ectype="catetopWarp">
	...
	<div class="limitime" id="limitime">
		<div class="hd">
			<h2><?php echo $this->_var['lang']['Flash_sale']; ?></h2>
			<h3><?php echo $this->_var['lang']['every_day']; ?></h3>
		</div>
		<div class="bd">
...
?>
	...
	<div class="catetop-lift lift-hide" ectype="lift">
    	<div class="lift-list" ectype="liftList">
        	<div class="catetop-lift-item lift-item-current" ectype="liftItem" data-target="#limitime"><span><?php echo $this->_var['lang']['Flash_sale']; ?></span></div>
        	<?php $_from = $this->_var['categories_child']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_43192500_1555918654');$this->_foreach['child'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['child']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_43192500_1555918654']):
        $this->_foreach['child']['iteration']++;
?>
            <div class="catetop-lift-item lift-floor-item" ectype="liftItem"><span><?php echo $this->_var['cat_0_43192500_1555918654']['name']; ?></span></div>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <div class="catetop-lift-item" ectype="liftItem" data-target="#atwillgo"><span><?php echo $this->_var['lang']['purchase_hand']; ?></span></div>
