...
<div class="street-list-item">
    ...
    <div class="info">
        ...
        <?php endif; ?>
        <p><?php if ($this->_var['shop']['shoprz_brandName']): ?><?php echo $this->_var['lang']['main_brand']; ?>： <?php echo $this->_var['shop']['shoprz_brandName']; ?><?php else: ?>&nbsp;<?php endif; ?></p>
        <p><?php if ($this->_var['shop']['grade_img']): ?><?php echo $this->_var['lang']['seller_Grade']; ?>： <!--<span class="shop-level-icon level-1"></span>--><img src="<?php echo $this->_var['shop']['grade_img']; ?>" title="<?php echo $this->_var['shop']['grade_name']; ?>" width="20"/><?php else: ?>&nbsp;<?php endif; ?></p>
    </div>
</div>
