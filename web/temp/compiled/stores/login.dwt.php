...
<head>
<meta charset="utf-8">
<title><?php echo $this->_var['lang']['login_title']; ?></title>
...
<div class="login-layout">
	<form method="post" id="form_login" action="privilege.php" name='theForm'>
    	<div class="login-form">
        	<div class="logo">
            <?php if ($this->_var['stores_login_logo']): ?>
            <img src="<?php echo $this->_var['stores_login_logo']; ?>" />
            <?php else: ?>
            ...
            <div class="formInfo">
            	<div class="formText">
                    ...
                    <input type="text" name="stores_user" autocomplete="off" class="input-text" value="" placeholder="<?php echo $this->_var['lang']['stores_user']; ?>">
                </div>
                <div class="formText mb10">
                	<i class="icon icon-pwd"></i>
                        <input type="password" style="display:none"/>
                    <input type="password" name="stores_pwd" autocomplete="off" class="input-text" value="" placeholder="<?php echo $this->_var['lang']['stores_pwd']; ?>">
                </div>
                <div class="formText mb10">
                ...
                <div class="formText submitDiv mb10">
                	...
                	<span class="text_span">
                        ...
                        <input type="text" name="captcha" class="input-yzm" placeholder="<?php echo $this->_var['lang']['input_yzm']; ?>" value="">
                    </span>
                    <?php endif; ?>
                    <span class="submit_span">
                    	<input type="hidden" name="act" value="signin" />
                        <input type="hidden" name="dsc_token" value="<?php echo $this->_var['dsc_token']; ?>" autocomplete="off" />
                        <input type="button" name="submit" class="sub" value="<?php echo $this->_var['lang']['login']; ?>" onclick="send_form_data('form[name=theForm]')">
                    </span>
                </div>
                <div class="formText">
                	<a href="get_password.php?act=forget_pwd" class="not_pwd" target="_blank"><?php echo $this->_var['lang']['forget_password_alt']; ?></a>
                </div>
            </div>
        </div>
	</form>
