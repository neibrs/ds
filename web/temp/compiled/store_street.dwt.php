                            ...
                            <div class="s-l-value">
                                <div class="s-l-v-list">
                                    <ul>
                                        ...
                                        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_07393600_1555918699');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_07393600_1555918699']):
?>
                                        <li <?php if ($this->_var['province_0_07393600_1555918699']['region_id'] == $this->_var['store_province']): ?>class="curr"<?php endif; ?>><a href="javascript:void(0);" data-val="<?php echo $this->_var['province_0_07393600_1555918699']['region_id']; ?>" data-type="search_city" data-region="1" ectype="street_area" ><?php echo $this->_var['province_0_07393600_1555918699']['region_name']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="s-l-value">
                                <div class="mod-list-sort">
                                    <div class="sort-l">
                                        ...
                                        <a href="javascript:void(0);" class="sort-item" ectype="seller_sort" data-sort='store_score' data-order='DESC'><?php echo $this->_var['lang']['score_street']; ?><i class="iconfont icon-up1"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
