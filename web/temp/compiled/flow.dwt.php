                ...
                <div class="cart-filter">
                    <div class="cart-stepflex">
                        <div class="cart-step-item curr">
                            <span>1.<?php echo $this->_var['lang']['my_cart']; ?></span>
                            <i class="iconfont icon-arrow-right-alt"></i>
                        </div>
                        <div class="cart-step-item">
                            <span>2.<?php echo $this->_var['lang']['fillin_order_info']; ?></span>
                            <i class="iconfont icon-arrow-right-alt"></i>
                        </div>
                        <div class="cart-step-item">
                            <span>3.<?php echo $this->_var['lang']['submit_order_success']; ?></span>
                        </div>
                    </div>
                        ...
                        <div class="cart-item" ectype="shopItem">
                            <div class="shop">
                                <div class="cart-checkbox" ectype="ckList">
                                    <input type="checkbox" id="shopid_<?php echo $this->_var['goodsRu']['ru_id']; ?>" name="checkShop" class="ui-checkbox CheckBoxShop" ectype="ckShopAll" data-ruid="<?php echo $this->_var['goodsRu']['ru_id']; ?>" />
                                    ...
                                    <div class="item-header" ectype="prpmoHeader">
                                        ...
                                        <div class="f-txt">
                                            ...
                                            <?php if ($this->_var['activity']['act_type_ext'] == 0): ?>
												...
												<a href="coudan.php?id=<?php echo empty($this->_var['activity']['act_id']) ? '0' : $this->_var['activity']['act_id']; ?>" class="ftx-05" target="_blank">&nbsp;<?php if ($this->_var['activity']['available']): ?><?php echo $this->_var['lang']['look_around']; ?><?php else: ?><?php echo $this->_var['lang']['gather_together']; ?><?php endif; ?>&nbsp;></a>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <?php if ($this->_var['activity']['available']): ?>
                                            ...
                                            <span class="f-price"><?php if ($this->_var['activity']['cart_fav_amount']): ?><em>¥</em><?php echo $this->_var['activity']['cart_fav_amount']; ?><?php endif; ?></span>
                                        </div>
                                        ...
                                        <div class="f-txt">
                                            ...
                                            <a href="coudan.php?id=<?php echo empty($this->_var['activity']['act_id']) ? '0' : $this->_var['activity']['act_id']; ?>" class="ftx-05" target="_blank"><?php if ($this->_var['activity']['available']): ?>&gt;<?php echo $this->_var['lang']['look_around']; ?><?php else: ?> &gt;<?php echo $this->_var['lang']['gather_together']; ?><?php endif; ?>&nbsp;</a>
                                            <span class="full-txt"><?php echo $this->_var['goods']['act_name']; ?></span>
                                            <span class="f-price"><div class="ml"><?php if ($this->_var['activity']['cart_fav_amount']): ?><em>¥</em><?php echo $this->_var['activity']['cart_fav_amount']; ?><?php endif; ?></div>
                                            <?php if ($this->_var['activity']['available']): ?><div  class="ftx-01 ml mt5"><?php echo $this->_var['lang']['been_reduced']; ?><em>¥</em><?php echo $this->_var['activity']['act_type_ext_format']; ?></div><?php endif; ?></span>
                                        </div>
                                        ...
                                        <div class="f-txt">
                                            ...
                                            <?php endif; ?>
                                            <a href="coudan.php?id=<?php echo empty($this->_var['activity']['act_id']) ? '0' : $this->_var['activity']['act_id']; ?>" target="_blank" class="ftx-05"> &gt;<?php if ($this->_var['activity']['available']): ?><?php echo $this->_var['lang']['look_around']; ?><?php else: ?><?php echo $this->_var['lang']['gather_together']; ?><?php endif; ?></a>
                                            <span class="full-txt"><?php echo $this->_var['goods']['act_name']; ?></span>
                                            <span class="f-price"><div class="ml"><?php if ($this->_var['activity']['cart_fav_amount']): ?><em>¥</em><?php echo $this->_var['activity']['cart_fav_amount']; ?><?php endif; ?></div><?php if ($this->_var['activity']['available']): ?><div  class="ftx-01 ml mt5"><?php echo $this->_var['lang']['been_reduced']; ?><?php echo $this->_var['activity']['goods_fav_amount']; ?></div><?php endif; ?></span>
...
?>
                                    <div class="item-item" ectype="item" data-recid="<?php echo $this->_var['goods']['rec_id']; ?>" data-goodsid="<?php echo $this->_var['goods']['goods_id']; ?>">
                                        <div class="item-form">
                                                ...
                                                <div class="goods-item">
                                                    ...
                                                    <div class="item-msg">
                                                        ...
                                                        <div class="gds-types">
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if ($this->_var['goods']['is_invalid']): ?><span class="red">（<?php echo $this->_var['lang']['expired']; ?>）</span><?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="cell s-price relative">
                                                <strong id="goods_price_<?php echo $this->_var['goods']['rec_id']; ?>"><?php echo $this->_var['goods']['formated_goods_price']; ?></strong>
                                                <?php if ($this->_var['goods']['favourable_list']): ?>
                                                <div class="promotion-info" ectype="promInfo">
                                                    <a href="javascript:void(0);" class="sales-promotion" ectype="c-promotion"><?php echo $this->_var['lang']['modules_txt_promo']; ?><i class="iconfont icon-down"></i></a>
                                                    <div class="promotion-tips" ectype="promTips">
                                                        <ul>
                                                            <?php $_from = $this->_var['goods']['favourable_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'fav');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['fav']):
?>
                                                            <li>
                                                                <input type="radio" class="ui-radio" data-aid="<?php echo $this->_var['key']; ?>" data-gid="<?php echo $this->_var['goods']['goods_id']; ?>" data-rid="<?php echo $this->_var['goods']['rec_id']; ?>" name="fav_<?php echo $this->_var['goods']['goods_id']; ?>" id="<?php echo $this->_var['goods']['goods_id']; ?>_<?php echo $this->_var['key']; ?>" ectype="changeFav"  <?php if ($this->_var['key'] == $this->_var['activity']['act_id']): ?>checked<?php endif; ?>>
                                                                <label for="<?php echo $this->_var['goods']['goods_id']; ?>_<?php echo $this->_var['key']; ?>" class="ui-radio-label"><?php echo $this->_var['fav']['act_name']; ?></label>
                                                            </li>
                                                ...
                                                <div class="goods-item">
                                                    ...
                                                    <div class="item-msg">
                                                        ...
                                                        <div class="package_goods" id="suit_<?php echo $this->_var['goods']['goods_id']; ?>">
                                                            <div class="title"><?php echo $this->_var['lang']['contain_goods']; ?>：</div>
                                                            <ul>
...
?>
                                                        ...
                                                        <p class="mt5"><strong><?php echo $this->_var['lang']['flow_store_notic']; ?></strong></p>
                                                        <?php endif; ?>
                                                        <?php endif; ?>
                                                        <div class="gds-types">
                                                            <?php if ($this->_var['goods']['stages_qishu'] != - 1): ?>
                                                            ...
                                                            <em class="gds-type gds-type-store"><?php echo $this->_var['lang']['parts']; ?></em>
                                                            <?php endif; ?>
                                                            <?php if ($this->_var['goods']['is_invalid']): ?><span class="red">（<?php echo $this->_var['lang']['expired']; ?>）</span><?php endif; ?>
                                                        </div>
                                                    </div>
                    ...
                    <div>
                        <p class="tr mt10">
                            <span class="mr10"><?php echo $this->_var['lang']['store_order_notic']; ?></span>
                            <a class="btn mr0" ectype="store_order"><i class="iconfont icon-store-alt"></i> <?php echo $this->_var['lang']['private_store_order']; ?></a>
                        </p>
                    </div>
                    <?php endif; ?>
            ...
            <div class="cart-empty">
                <div class="cart-message">
                    <div class="txt"><?php echo $this->_var['lang']['shopping_cart_notice']; ?></div>
                    <div class="info">
                        <a href="./index.php" class="btn sc-redBg-btn"><?php echo $this->_var['lang']['go_around']; ?></a>
                        <?php if (! $this->_var['user_id']): ?><a href="javascript:void(0);" id="go_pay" data-url="flow.php" class="login"><?php echo $this->_var['lang']['login_cart']; ?></a><?php endif; ?>
                    </div>
                </div>
            </div>
            <?php endif; ?>
        	...
        	<div class="checkout-warp">
                ...
                <div class="ck-step" id="consignee_list">
                	<div class="ck-step-tit">
                        ...
                        <a href="user.php?act=address_list" class="extra-r" target="_blank"><?php echo $this->_var['lang']['flow_consignee']; ?></a>
                    </div>
                                ...
                                <div class="item_value" ectype="regionLinkage">
                                    <dl class="mod-select mod-select-small" ectype="smartdropdown" id="selProvinces">
                                        ...
                                        <dd ectype="layer">
                                            ...
                                            <?php $_from = $this->_var['provinces']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_99580700_1555894833');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_99580700_1555894833']):
?>
                                            <div class="option" data-value="<?php echo $this->_var['province_0_99580700_1555894833']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_99580700_1555894833']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_99580700_1555894833']['region_name']; ?></div>
                                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                        </dd>
                                    </dl>
...
?>
                                    ...
                                    <dl class="mod-select mod-select-small" ectype="smartdropdown" id="seller_soter" style="display:none;">
                                    	<dt><span class="txt" ectype="txt"><?php echo $this->_var['lang']['select_store']; ?></span></dt>
                                        <dd ectype="layer"></dd>
                                    </dl>
...
?>
                ...
                <div class="ck-step">
                	<div class="ck-step-tit">
                        ...
                        <?php else: ?>
                        <a href="javascript:history.go(-1);" class="extra-r"><?php echo $this->_var['lang']['back_up_page']; ?></a>
                        <?php endif; ?>
                    </div>
                    <div class="ck-step-cont">
                ...
                <div class="ck-step">
                	<div class="ck-step-tit">
                        ...
                        <div class="tips-new-white">
                            <b></b><span><i></i><?php echo $this->_var['lang']['Invoice_information_notice']; ?></span>
                        </div>
                    </div>
                            ...
                            <div class="other-list">
                                ...
                                <div class="qt_item" id="qt_balance" <?php if ($this->_var['disable_surplus']): ?> style="display:none"<?php endif; ?>>
                                    ...
                                    <div class="item_value">
                                        ...
                                        <div class="sp"><span><?php echo $this->_var['lang']['current']; ?><?php echo $this->_var['lang']['your_surplus']; ?></span><em>￥<?php echo empty($this->_var['your_surplus']) ? '0' : $this->_var['your_surplus']; ?></em></div>
...
?>
                ...
                <div class="ck-step ck-step-other">
                	<div class="ck-step-tit ck-toggle ck-toggle-off" ectype="ck-toggle">
                        ...
                        <?php if ($this->_var['user_coupons'] || $this->_var['value_card_list'] && $this->_var['is_value_cart'] == 1 || $this->_var['bonus_list']): ?><span class="tag"><?php echo $this->_var['lang']['available']; ?></span><?php endif; ?>
                    </div>
...
?>
                                    <div class="panl-item" ectype="panlItem" data-ucid="<?php echo $this->_var['value_card']['vc_id']; ?>"data-type="value_card">
                                    	...
                                    	<strong style="font-size:28px;"><?php echo $this->_var['value_card']['card_money_formated']; ?></strong>
                                    	<p class="tit" style="margin-top:10px;"><?php echo $this->_var['lang']['end_date']; ?>:<?php echo $this->_var['value_card']['end_time']; ?></p>
                                    ...
                                    <div class="panl-item panl-item-new">
                                    	<a href="user.php?act=value_card" target="_blank" class="add-new-stored">
                                            ...
                                            <em><?php echo $this->_var['lang']['add_stored_value_card']; ?></em>
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="w w1200">
            ...
            <div class="payOrder-warp" id="pay_main">
                <div class="payOrder-desc">
                    <div class="pay-top">
                        <h3><?php if ($this->_var['order']['order_amount'] > 0): ?><?php echo $this->_var['lang']['checkout_success_notic']; ?><?php else: ?><?php echo $this->_var['lang']['checkout_success_end']; ?><?php endif; ?></h3>
                        <div class="pay-total">
                            <span><?php echo $this->_var['lang']['cope_with']; ?><?php echo $this->_var['stages_info']['stages_qishu']; ?><?php echo $this->_var['lang']['total']; ?>：</span>
                    ...
                    <div class="pay-txt">
                        ...
                        <?php else: ?>
                            ...
                            <p><?php echo $this->_var['lang']['shipping_method']; ?>: <span id="express"><?php echo $this->_var['order']['shipping_name']; ?></span></p>
                            <?php endif; ?>
                            <?php else: ?>
...
?>
                        <div class="shopend-info-item">
                            ...
                            <p><?php echo $this->_var['lang']['order_amount']; ?>：<em><?php echo $this->_var['c_order']['amount_formated']; ?></em></p>
                            <?php endif; ?>
                            
                            <?php if ($this->_var['c_order']['pay_total'] > 0): ?>
                            <p><?php echo $this->_var['lang']['amount_paid']; ?>：<em><?php echo $this->_var['c_order']['total_formated']; ?></em></p>
                            <?php endif; ?>
                            ...
                            <?php else: ?>
                            <p><?php echo $this->_var['lang']['Consignee']; ?>：<span id="username"><?php echo $this->_var['order']['consignee']; ?></span><span id="tel" class="ml20"><?php echo $this->_var['order']['mobile']; ?></span></p>
                            <p><?php echo $this->_var['lang']['Send_to']; ?>：<span id="address"><?php echo $this->_var['address_info']; ?>&nbsp;<?php echo $this->_var['order']['address']; ?></span></p>
                            <?php endif; ?>
                        </div>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </div>
                        ...
                        <div class="payOrder-list">
                            <div class="p-mode-list">
                                <div class="p-mode-item chunsejinrong">
                                    <a href="flow.php?step=done&act=chunsejinrong&order_sn=<?php echo $this->_var['order']['order_sn']; ?>" id="chunsejinrong" order_sn="<?php echo $this->_var['order']['order_sn']; ?>" class="fl" flag="chunsejinrong"><?php echo $this->_var['lang']['ious_pay']; ?></a>
                                </div>
                                <div class="bt-desc">
                                	<p>
                                        <span class="mr10"><?php echo $this->_var['lang']['Available_Credit']; ?>：<?php echo $this->_var['stages_info']['baitiao']; ?><?php echo $this->_var['lang']['yuan']; ?></span>
                                        <span><?php echo $this->_var['lang']['next_repayment_day']; ?>：<?php echo $this->_var['stages_info']['repay_date']; ?></span>
                                    </p>
                    ...
                    <?php else: ?>
                        <div class="payOrder-list">
                            <div class="p-mode-tit">
                                <h3><?php echo $this->_var['lang']['payment_is_online']; ?></h3>
                            </div>
                            <div class="p-mode-list">
                    ...
                    <div class="shopend-info">
                        ...
                        <div class="s-i-right">
                            ...
                            <?php if ($this->_var['order']['pay_code'] == 'cod'): ?>
                                <?php echo $this->_var['lang']['pay_code_notic_one']; ?>
                            <?php elseif ($this->_var['order']['pay_code'] == 'bank'): ?>
                                <?php echo $this->_var['lang']['pay_code_notic_two']; ?>
                            <?php else: ?>
                            	<?php if ($this->_var['order']['pay_code'] == 'balance'): ?>
                                <?php echo $this->_var['lang']['payment_Success']; ?>
                                <?php else: ?>
                                <?php echo $this->_var['lang']['pay_code_notic_three']; ?>  
                                <?php endif; ?>
                            <?php endif; ?>
                            </h3>
...
?>
                    ...
                    <div class="clear"></div>
                    <div class="s-i-btn">
                        <a href="<?php if ($this->_var['is_zc_order']): ?>user.php?act=crowdfunding<?php else: ?>user.php?act=order_list<?php endif; ?>" class="btn sc-redBg-btn"><?php echo $this->_var['lang']['view_order']; ?></a>
                        <?php echo $this->_var['lang']['back_home']; ?>
                    </div>
                </div>
                <?php else: ?>
                <div class="shopend-info">
                    ...
                    <div class="s-i-right">
                        ...
                        <div class="s-i-tit">
                            <p><?php echo $this->_var['lang']['order_number']; ?>：<em id="nku"><?php echo $this->_var['order']['order_sn']; ?></em></p>
                            <?php if ($this->_var['stores_info']): ?>
                            <p><?php echo $this->_var['lang']['shipping_method']; ?>：<em><?php echo $this->_var['lang']['private_store']; ?></em></p>
                            <p><?php echo $this->_var['lang']['store_name']; ?>：<em><?php echo $this->_var['stores_info']['stores_name']; ?></em></p>
                            <?php else: ?>
                            <?php if (! $this->_var['is_group_buy']): ?>
                        ...
                        <div class="s-i-btn">
                            ...
                            <a href="user.php?act=crowdfunding" class="btn sc-redBg-btn"><?php echo $this->_var['lang']['view_order']; ?></a>
                            <?php else: ?>
                            <a href="user.php?act=order_list" class="btn sc-redBg-btn"><?php echo $this->_var['lang']['view_order']; ?></a>
                            <?php endif; ?>
                           <?php echo $this->_var['lang']['back_home']; ?>
                        </div>
                    </div>
            ...
            <div class="p-panel-main c-history">
                <div class="ftit ftit-delr"><h3><?php echo $this->_var['lang']['ftit_delr']; ?></h3></div>
                <div class="gl-list clearfix">
                    <ul class="clearfix">
