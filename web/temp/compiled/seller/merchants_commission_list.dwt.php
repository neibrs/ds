        ...
        <div class="ecsc-layout-right">
            <div class="main-content" id="mainContent">
                ...
                <div class="explanation clear mb20" id="explanation">
                    <div class="ex_tit"><i class="sc_icon"></i><h4><?php echo $this->_var['lang']['reminder']; ?></h4></div>
                    <ul>
                    	<li><?php echo $this->_var['lang']['operation_prompt_content']['list']['0']; ?></li>
                    	<li><?php echo $this->_var['lang']['operation_prompt_content']['detail']['4']; ?></li>
                    	<li><?php echo $this->_var['lang']['operation_prompt_content']['detail']['5']; ?></li>
                    </ul>
                </div>
                ...
                <?php endif; ?>
                  <table class="ecsc-default-table goods-default-table mt20">	
                    ...
                    <tr>
                      <th width="6%">
                        <div class="first_all"><?php echo $this->_var['lang']['record_id']; ?></div>
                      </th>
...
?>
                    <tr>
                      <td class="first_td_checkbox">
                        <div class="first_all"><?php echo $this->_var['commission']['server_id']; ?></div>
                      </td>
                      ...
                      <td style="color:#179f27" >
                        ...
                        <?php if ($this->_var['commission']['is_goods_rate'] && $this->_var['commission']['is_settlement_price'] != 0): ?>
                            <p><em class="red"><?php echo $this->_var['lang']['include_goods_k']; ?></em></p>
                       	<?php endif; ?>
                      </td>
                      <td style="color:#F00" >
