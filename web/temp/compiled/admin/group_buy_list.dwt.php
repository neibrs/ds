        ...
        <div class="content">
            	...
            	<div class="ex_tit">
                    ...
                    <div class="view-case">
                        ...
                        <div class="view-case-info">
                        	<a href="http://help.ecmoban.com/article-6542.html" target="_blank"><?php echo $this->_var['lang']['tutorials_bonus_list_one']; ?></a>
                        </div>
                    </div>			
                    <?php endif; ?>			
				</div>
            ...
            <div class="flexilist">
            	<div class="common-head">
                	...
                	<div class="fl">
                        <a href="group_buy.php?act=add"><div class="fbutton"><div class="add" title="<?php echo $this->_var['lang']['add_group_buy']; ?>"><span><i class="icon icon-plus"></i><?php echo $this->_var['lang']['add_group_buy']; ?></span></div></div></a>
                    </div>
                    <?php endif; ?>
                    <div class="refresh">
                    	...
                    	<table cellpadding="1" cellspacing="1" class="table_layout">
                        	<thead>
                            	<tr>
                                    ...
                                    <th width="8%"><div class="tDiv"><?php echo $this->_var['lang']['end_date']; ?></div></th>
                                    <th width="6%"><div class="tDiv"><?php echo $this->_var['lang']['deposit']; ?> </div></th>
                                    <th width="6%"><div class="tDiv"><?php echo $this->_var['lang']['restrict_amount']; ?></div></th>
                                    <th width="6%"><div class="tDiv"><?php echo $this->_var['lang']['valid_goods']; ?></div></th>
                                    <th width="6%"><div class="tDiv"><?php echo $this->_var['lang']['valid_order']; ?></div></th>
                                    <th width="6%"><div class="tDiv"><?php echo $this->_var['lang']['current_price']; ?></div></th>
...
?>
                            	<tr>
                                	<td class="sign">
                                        <div class="tDiv">
                                            <input type="checkbox" name="checkboxes[]" value="<?php echo $this->_var['group_buy']['act_id']; ?>" class="checkbox" id="checkbox_<?php echo $this->_var['group_buy']['act_id']; ?>" />
                                            <label for="checkbox_<?php echo $this->_var['group_buy']['act_id']; ?>" class="checkbox_stars"></label>
                                        </div>
                                    </td>
                                    <td><div class="tDiv"><?php echo $this->_var['group_buy']['act_id']; ?></div></td>
                                	<td>
                                        <div class="tDiv overflow_view">
                                            <span title="<?php echo htmlspecialchars($this->_var['group_buy']['goods_name']); ?>" data-toggle="tooltip"><?php echo htmlspecialchars($this->_var['group_buy']['goods_name']); ?></span>
                                            <p class="red"><?php echo $this->_var['group_buy']['cur_status']; ?></p>
                                        </div>
                                    </td>
                                    <td><div class="tDiv"><?php if ($this->_var['group_buy']['user_name']): ?><font class="red"><?php echo $this->_var['group_buy']['user_name']; ?></font><?php else: ?><?php echo $this->_var['lang']['self']; ?><?php endif; ?></div></td>
                                    <td><div class="tDiv"><?php echo $this->_var['group_buy']['end_time']; ?></div></td>
                                    <td><div class="tDiv"><span onclick="listTable.edit(this, 'edit_deposit', <?php echo $this->_var['group_buy']['act_id']; ?>)"><?php echo $this->_var['group_buy']['deposit']; ?></span></div></td>
                                    <td><div class="tDiv"><span onclick="listTable.edit(this, 'edit_restrict_amount', <?php echo $this->_var['group_buy']['act_id']; ?>)"><?php echo $this->_var['group_buy']['restrict_amount']; ?></span></div></td>
                                    <td><div class="tDiv"><?php echo $this->_var['group_buy']['valid_goods']; ?></div></td>
                                    <td><div class="tDiv"><?php echo $this->_var['group_buy']['valid_order']; ?></div></td>
                                    <td><div class="tDiv"><?php echo $this->_var['group_buy']['cur_price']; ?></div></td>
                                    <td>
                                    	<div class="tDiv">
                                            <?php if ($this->_var['group_buy']['review_status'] == 1): ?>
                                            <font class="org2"><?php echo $this->_var['lang']['not_audited']; ?></font>
                                            <?php elseif ($this->_var['group_buy']['review_status'] == 2): ?>
                                            <font class="red"><?php echo $this->_var['lang']['audited_not_adopt']; ?></font><br/>
                                            <i class="tip yellow" title="<?php echo $this->_var['group_buy']['review_content']; ?>" data-toggle="tooltip"><?php echo $this->_var['lang']['prompt']; ?></i>
                                            <?php elseif ($this->_var['group_buy']['review_status'] == 3): ?>
                                    ...
                                    <td class="handle">
										<div class="tDiv ht_tdiv">
                                            <a href="order.php?act=list&amp;group_buy_id=<?php echo $this->_var['group_buy']['act_id']; ?><?php echo $this->_var['seller_list']; ?>" class="btn_see"><i class="sc_icon sc_icon_see"></i><?php echo $this->_var['lang']['view']; ?></a>
                                            <a href="group_buy.php?act=edit&amp;id=<?php echo $this->_var['group_buy']['act_id']; ?>"  class="btn_edit" title="<?php echo $this->_var['lang']['edit']; ?>"><i class="icon icon-edit"></i><?php echo $this->_var['lang']['edit']; ?></a>
                                            <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['group_buy']['act_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" class="btn_trash" title="<?php echo $this->_var['lang']['remove']; ?>"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['drop']; ?></a>					
										</div>
									</td>
                                </tr>
							<?php endforeach; else: ?>
