        ...
        <div class="content">
            	...
            	<div class="ex_tit">
                    ...
                    <div class="view-case">
                        ...
                        <div class="view-case-info">
                        	<a href="http://help.ecmoban.com/article-6551.html" target="_blank"><?php echo $this->_var['lang']['tutorials_bonus_list_one']; ?></a>
                        </div>
                    </div>			
                    <?php endif; ?>				
				</div>
            ...
            <div class="flexilist">
            	<div class="common-head">
                	...
                	<div class="fl">
                        <a href="package.php?act=add"><div class="fbutton"><div class="add" title="<?php echo $this->_var['lang']['add_package']; ?>"><span><i class="icon icon-plus"></i><?php echo $this->_var['lang']['add_package']; ?></span></div></div></a>
                    </div>
                    <?php endif; ?>
                    <div class="refresh">
                    ...
                    <div class="search">
                        ...
                        <?php endif; ?>
                    	<div class="input">
                        	<input type="text" name="keywords" class="text nofocus" placeholder="<?php echo $this->_var['lang']['package_name']; ?>" autocomplete="off" />
...
?>
                            	<tr>
									<td class="sign">
                                        <div class="tDiv">
                                            <input type="checkbox" name="checkboxes[]" value="<?php echo $this->_var['package']['act_id']; ?>" class="checkbox" id="checkbox_<?php echo $this->_var['package']['act_id']; ?>" />
                                            <label for="checkbox_<?php echo $this->_var['package']['act_id']; ?>" class="checkbox_stars"></label>
                                        </div>
                                    </td>
                                    ...
                                    <td class="handle">
										<div class="tDiv a2">
											...
											<a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['package']['act_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>" class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['drop']; ?></a>	
										</div>
									</td>
                                </tr>
							<?php endforeach; else: ?>
