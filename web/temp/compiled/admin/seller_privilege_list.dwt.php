...
<body class="iframe_body">
	<div class="warpper">
    	<div class="title"><?php echo $this->_var['lang']['privilege']; ?> - <?php echo $this->_var['ur_here']; ?></div>
        <div class="content">
...
?>
                            	<tr>
                                    ...
                                    <td><div class="tDiv"><?php if ($this->_var['list']['ru_id']): ?><font class="red"><?php echo $this->_var['list']['ru_name']; ?></font><?php else: ?><font class="blue3"><?php if ($this->_var['list']['agency_id']): ?><a href="agency.php?act=edit&id=<?php echo $this->_var['list']['agency_id']; ?>"><?php echo $this->_var['list']['agency']['agency_name']; ?></a><?php else: ?><?php echo $this->_var['lang']['seller_admin']; ?><?php endif; ?></font><?php endif; ?></div></td>
