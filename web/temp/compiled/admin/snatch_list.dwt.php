        ...
        <div class="content">
            	...
            	<div class="ex_tit">
                    ...
                    <div class="view-case">
                        ...
                        <div class="view-case-info">
                        	<a href="http://help.ecmoban.com/article-6400.html" target="_blank"><?php echo $this->_var['lang']['tutorials_bonus_list_one']; ?></a>
                        </div>
                    </div>			
                    <?php endif; ?>	
				</div>
            ...
            <div class="flexilist">
            	<div class="common-head">
                	...
                	<div class="fl">
                        <a href="snatch.php?act=add"><div class="fbutton"><div class="add" title="<?php echo $this->_var['lang']['add_snatch']; ?>"><span><i class="icon icon-plus"></i><?php echo $this->_var['lang']['add_snatch']; ?></span></div></div></a>
                    </div>
                    <?php endif; ?>
                    <div class="refresh">
                    	...
                    	<table cellpadding="0" cellspacing="0" border="0" class="table_layout">
                        	<thead>
                            	<tr>
                                    ...
                                    <th width="10%"><div class="tDiv"><?php echo $this->_var['lang']['end_time']; ?></div></th>
                                    ...
                                    <th width="5%"><div class="tDiv"><?php echo $this->_var['lang']['is_hot']; ?></div></th>
...
?>
                            	<tr>
                                    ...
                                    <td>
                                    	<div class="tDiv">
                                        	<div class="switch mauto <?php if ($this->_var['snatch']['is_hot']): ?>active<?php endif; ?>" onclick="listTable.switchBt(this, 'toggle_hot', <?php echo $this->_var['snatch']['act_id']; ?>)" title="<?php echo $this->_var['lang']['yes']; ?>">
                                    ...
                                    <td class="handle">
										<div class="tDiv ht_tdiv">
											...
											<a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['snatch']['act_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>" class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['drop']; ?></a>									
										</div>
									</td>
                                </tr>
							<?php endforeach; else: ?>
