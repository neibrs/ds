...
<title><?php echo $this->_var['lang']['title']; ?></title>
...
<body class="visible">
	<div class="design-nav-wrap fixed">
        <div class="btns">
            <a href="javascript:void(0);" class="btn btn_blue" ectype="downloadModal"><?php echo $this->_var['lang']['confirmation_release']; ?></a>
            <a href="javascript:void(0);" class="btn" ectype="back" <?php if ($this->_var['is_temp'] == 0): ?>style="display:none"<?php endif; ?>><?php echo $this->_var['lang']['restore']; ?></a>
            <a href="javascript:void(0);" class="btn" ectype="preview"><?php echo $this->_var['lang']['preview']; ?></a>
            <a href="javascript:void(0);" class="btn" ectype="restore"><?php echo $this->_var['lang']['restore_default']; ?></a>
        </div>
    </div>
	<div class="article-index" ectype="visualShell">
        <?php if ($this->_var['pc_page']): ?>
        <?php echo $this->_var['pc_page']; ?>
        <?php else: ?>
            ...
            <div class="visual-item lyrow ui-draggable" data-purebox="CMS" data-mode="CMS_ADV">
            	<div class="drag" data-html="not">
                    <div class="setup_box">
                        ...
                        <a href="javascript:void(0);" class="move-remove"><i class="iconfont icon-remove-alt"></i><?php echo $this->_var['lang']['drop']; ?></a>
                    </div>
                </div>
                    ...
                    <div class="article-box">
                        ...
                        <div class="ab-bd">
                            <ul class="quick clearfix">
                                <li>
                                    <div class="q-img"><a href="http://about.ecmoban.com/staffs.php" target="_blank"><img src="images/article-index/col3.jpg" alt=""></a></div>
                                ...
                                <li>
                                    <div class="q-img"><a href="http://about.ecmoban.com/staffs.php" target="_blank"><img src="images/article-index/col4.jpg" alt=""></a></div>
                                ...
                                <li>
                                    <div class="q-img"><a href="http://about.ecmoban.com/article-6390.html" target="_blank"><img src="images/article-index/col5.jpg" alt=""></a></div>
                                ...
                                <li>
                                    <div class="q-img"><a href="http://about.ecmoban.com/article-7772.html" target="_blank"><img src="images/article-index/col6.jpg" alt=""></a></div>
