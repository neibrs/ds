                    ...
                    <div class="mian-info">
                        <form action="goods_transport.php" method="post" name="theForm" enctype="multipart/form-data" id="goods_transport_form">
                            <div class="switch_info">
                                ...
                                <div class="<?php if ($this->_var['transport_info']['freight_type'] != 0): ?> hide<?php endif; ?>" id="Fixed_freight">
                                    <div class="item">
                                ...
                                <div class="<?php if ($this->_var['transport_info']['freight_type'] == 0): ?> hide<?php endif; ?>" id="Template_freight">
                                    <div class="item">
...
?>
                                ...
                                <div class="item">
                                    ...
                                    <div class="label_value info_btn">
                                        ...
                                        <input name="submit" type="submit" value="<?php echo $this->_var['lang']['button_submit']; ?>" class="button fl mr10" id="submitBtn">
                                    </div>
                                </div>								
                            </div>
                        </form>
