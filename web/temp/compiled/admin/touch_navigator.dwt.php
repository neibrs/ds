...
<body class="iframe_body">
	<div class="warpper">
    	<div class="title"><?php echo $this->_var['lang']['ectouch']; ?> - <?php echo $this->_var['ur_here']; ?></div>
        <div class="content">
...
?>
                            	<tr>
                                    ...
                                    <td>
                                    	<div class="tDiv">
                                            <div class="switch <?php if ($this->_var['val']['ifshow']): ?>active<?php endif; ?>" title="<?php if ($this->_var['val']['ifshow']): ?><?php echo $this->_var['lang']['yes']; ?><?php else: ?><?php echo $this->_var['lang']['no']; ?><?php endif; ?>" onclick="listTable.switchBt(this, 'toggle_ifshow', <?php echo $this->_var['val']['id']; ?>)">
                                    ...
                                    <td>
                                    	<div class="tDiv">
                                            <div class="switch <?php if ($this->_var['val']['opennew']): ?>active<?php endif; ?>" title="<?php if ($this->_var['val']['opennew']): ?><?php echo $this->_var['lang']['yes']; ?><?php else: ?><?php echo $this->_var['lang']['no']; ?><?php endif; ?>" onclick="listTable.switchBt(this, 'toggle_opennew', <?php echo $this->_var['val']['id']; ?>)">
                                            	<div class="circle"></div>
                                            </div>
                                            <input type="hidden" value="0" name="">
                                        </div>
                                    ...
                                    <td class="handle">
                                        <div class="tDiv a2">
                                            ...
                                            <a href="javascript:confirm_redirect('<?php echo $this->_var['lang']['ckdel']; ?>', 'touch_navigator.php?act=del&id=<?php echo $this->_var['val']['id']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>" class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['drop']; ?></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; else: ?>
