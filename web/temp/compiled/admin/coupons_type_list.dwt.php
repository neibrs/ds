        ...
        <div class="content">
            	...
            	<div class="ex_tit">
                    ...
                    <div class="view-case">
                        ...
                        <div class="view-case-info">
                        	<a href="http://help.ecmoban.com/article-6550.html" target="_blank"><?php echo $this->_var['lang']['tutorials_bonus_list_one']; ?></a>
                        </div>
                    </div>			
                    <?php endif; ?>				
				</div>
            ...
            <div class="flexilist">
            	<div class="common-head">
                	...
                	<div class="fl">
                        <a href="coupons.php?act=add"><div class="fbutton"><div class="add" id="actionSpan" title="<?php echo $this->_var['lang']['continus_add']; ?>"><span><i class="icon icon-plus"></i><?php echo $this->_var['lang']['continus_add']; ?></span></div></div></a>
                    </div>
                    <?php endif; ?>
                    <div class="refresh">
                    ...
                    <div class="search">
                        ...
                        <?php endif; ?>
                    	<div class="input">
                        	<input type="text" name="cou_name" class="text nofocus" placeholder="<?php echo $this->_var['lang']['coupons_name']; ?>" autocomplete="off" />
                    	...
                    	<table cellpadding="1" cellspacing="1" >
                        	<thead>
                            	<tr>
                                    ...
                                    <th width="6%"><div class="tDiv"><?php echo $this->_var['lang']['coupons_type']; ?></div></th>
                                    <th width="6%"><div class="tDiv"><?php echo $this->_var['lang']['use_goods']; ?></div></th>
                                    <th width="5%"><div class="tDiv"><?php echo $this->_var['lang']['use_limit']; ?></div></th>
                                    <th width="5%"><div class="tDiv"><?php echo $this->_var['lang']['coupons_value']; ?></div></th>
                                    <th width="5%"><div class="tDiv"><?php echo $this->_var['lang']['give_out_amount']; ?></div></th>
                                    <th width="8%"><div class="tDiv"><?php echo $this->_var['lang']['valid_date']; ?></div></th>
									<th width="5%"><div class="tDiv"><?php echo $this->_var['lang']['is_overdue']; ?></div></th>
...
?>
                            <tr>
								<td class="sign">
									<div class="tDiv">
										<input type="checkbox" name="checkboxes[]" value="<?php echo $this->_var['vo']['cou_id']; ?>" class="checkbox" id="checkbox_<?php echo $this->_var['vo']['cou_id']; ?>" />
										<label for="checkbox_<?php echo $this->_var['vo']['cou_id']; ?>" class="checkbox_stars"></label>
									</div>
								</td>
                                ...
                                <td><div class="tDiv" <?php if ($this->_var['vo']['type'] == 5): ?> title='<?php echo $this->_var['vo']['free_value_name']; ?>' data-toggle="tooltip"<?php endif; ?>><?php echo $this->_var['vo']['cou_type']; ?></div></td>
                                <td>
                                	<div class="tDiv">
                                    	<?php if (! $this->_var['vo']['cou_goods'] && ! $this->_var['vo']['spec_cat']): ?>
                                        	<span class="blue"><?php echo $this->_var['lang']['goods_all']; ?></span>
                                        <?php elseif ($this->_var['vo']['cou_goods'] && ! $this->_var['vo']['spec_cat']): ?>
                                        	<span class="red"><?php echo $this->_var['lang']['goods_appoint']; ?></span>
                                        <?php elseif (! $this->_var['vo']['cou_goods'] && $this->_var['vo']['spec_cat']): ?>
                                        	<span class="green"><?php echo $this->_var['lang']['spec_cat']; ?></span>
                                        <?php endif; ?>	
                                    </div>
                                </td>
                                ...
                                <td><div class="tDiv"><?php echo $this->_var['vo']['cou_start_time']; ?><br><?php echo $this->_var['vo']['cou_end_time']; ?></div></td>
                                ...
                                <td class="handle">
                                    <div class="tDiv a3">
										<?php if ($this->_var['vo']['type'] == 3 || $this->_var['vo']['type'] == 4 || $this->_var['vo']['type'] == 5): ?>
                                        <div id="clip_container" class="clip_container">
                                        	<a href="javascript:void(0);" data-url="<?php echo $this->_var['url']; ?>coupons.php?act=coupons_info&id=<?php echo $this->_var['vo']['cou_id']; ?>" data-id="<?php echo $this->_var['vo']['cou_id']; ?>" title="<?php echo $this->_var['lang']['copy_url']; ?>" class="btn_inst" ectype="clip_button" id="clip_button_<?php echo $this->_var['vo']['cou_id']; ?>"><i class="icon icon-copy"></i><?php echo $this->_var['lang']['copy_url']; ?></a> 
                                        </div>	
										<?php endif; ?>										
                                        ...
                                        <a href="javascript:;" onclick="coupons_del(<?php echo $this->_var['vo']['cou_id']; ?>)" title="<?php echo $this->_var['lang']['remove']; ?>" class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['drop']; ?></a>									
                                    </div>
                                </td>
                            </tr>
							<?php endforeach; else: ?>
