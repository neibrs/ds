...
?>
                                            ...
                                            <input type="hidden" value="<?php echo empty($this->_var['goods_type']['c_id']) ? '0' : $this->_var['goods_type']['c_id']; ?>" id="parent_id_val<?php if ($this->_var['cat_tree1']['arr']): ?>3<?php else: ?>2<?php endif; ?>" ectype="typeCatVal">
                                        </div>
                                        <?php endif; ?>
                                        <input name="attr_parent_id" type="hidden" value="<?php echo empty($this->_var['goods_type']['c_id']) ? '0' : $this->_var['goods_type']['c_id']; ?>">
                                    </div>
                                </div>
