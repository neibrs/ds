                ...
                <div class="common-content">
                	<div class="list-div"  id="listDiv">
                    	...
                    	<table cellpadding="0" cellspacing="0" border="0">
                        	<thead>
                            	<tr>
                                    <th width="30%"><div class="tDiv"><?php echo $this->_var['lang']['position_name']; ?></div></th>
                                    <th width="10%"><div class="tDiv"><?php echo $this->_var['lang']['goods_steps_name']; ?></div></th>
                                    <th width="10%"><div class="tDiv"><?php echo $this->_var['lang']['posit_width']; ?></div></th>
                                    <th width="10%"><div class="tDiv"><?php echo $this->_var['lang']['posit_height']; ?></div></th>
                                    <th width="20%"><div class="tDiv"><?php echo $this->_var['lang']['position_desc']; ?></div></th>
...
?>
                            	<tr>
                                    ...
                                    <?php else: ?>
                                        <?php if ($this->_var['priv_ru'] == 1): ?>
                                        <td><div class="tDiv"><?php if ($this->_var['list']['user_name']): ?><font style="color:#F00;"><?php echo $this->_var['list']['user_name']; ?></font><?php else: ?><font class="blue"><?php echo $this->_var['lang']['self_run']; ?></font><?php endif; ?></div></td>
                                        <?php endif; ?>
                                    <?php endif; ?>
