                ...
                <dl class="w300">
                    ...
                    <dd>
                        ...
                        <div id="sel_mode" class="imitate_select select_w140" style="display: none;">
                            <div class="cite"><?php echo $this->_var['lang']['please_select']; ?></div>
                            <ul>
                                <li><a href="javascript:get_brand_type(0);" data-value="0" class="ftx-01"><?php echo $this->_var['lang']['please_select']; ?></a></li>
                                <li><a href="javascript:get_brand_type(1);" data-value="1" class="ftx-01"><?php echo $this->_var['lang']['sort_keywords']; ?></a></li>
                                <li><a href="javascript:get_brand_type(2);" data-value="2" class="ftx-01"><?php echo $this->_var['lang']['sort_list']; ?></a></li>
                            </ul>
                        ...
                        <div id="brandId" class="imitate_select select_w140" <?php if ($this->_var['priv_ru'] == 1): ?>style="display:none"<?php endif; ?>>
                            <div class="cite"><?php echo $this->_var['lang']['please_select']; ?></div>
                            <ul>
...
<script type="text/javascript">
	...
	function searchGoods()
	{
		...
		if(document.forms['searchHighForm'].elements['sel_brand']){
			listTable.filter['sel_brand'] = document.forms['searchHighForm'].elements['sel_brand'].value;
			listTable.filter['store_brand'] = document.forms['searchHighForm'].elements['store_brand'].value;
		}
		...
		if(document.forms['searchHighForm'].elements['sel_mode']){
			listTable.filter['sel_mode'] = Utils.trim(document.forms['searchHighForm'].elements['sel_mode'].value);
		}
