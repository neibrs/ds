...
?>
                ...
                <?php else: ?>
                    <input type="text" name="attr_value_list[]" class="text" value="<?php echo $this->_var['val']['this_value']; ?>" autocomplete="off" onblur="insert_attr_input_val(this)"/>
                <?php endif; ?>
...
?>
                    ...
                    <div class="checkbox_item">
                    <a href="javascript:void(0);" class="btn btn25 blue_btn" data-attrid="<?php echo $this->_var['val']['attr_id']; ?>" ectype="attr_input"><?php echo $this->_var['lang']['custom']; ?></a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
?>
        ...
        <div class="select">
        	<div class="fl"><?php echo $this->_var['val']['attr_name']; ?>：</div>
...
?>
        ...
        <?php endif; ?>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        <a href="javascript:void(0);" class="btn btn30 blue_btn" ectype="search_attr"><?php echo $this->_var['lang']['search_word']; ?></a>
    </div>
</div>
<?php endif; ?>