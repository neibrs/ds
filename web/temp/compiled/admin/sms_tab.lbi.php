<div class="tabs_info">
    <ul>
        ...
        <li <?php if ($this->_var['menu_select']['current'] == 'dscsms_configure'): ?>class="curr"<?php endif; ?>><a href="dscsms_configure.php?act=list"><?php echo $this->_var['lang']['dscsms_configure']; ?></a></li>
