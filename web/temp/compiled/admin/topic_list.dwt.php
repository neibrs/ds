        ...
        <div class="content">
            	...
            	<div class="ex_tit">
                    ...
                    <div class="view-case">
                        ...
                        <div class="view-case-info">
                        	<a href="http://help.ecmoban.com/article-6547.html" target="_blank"><?php echo $this->_var['lang']['tutorials_bonus_list_one']; ?></a>
                        </div>
                    </div>			
                    <?php endif; ?>				
				</div>
            ...
            <div class="flexilist">
            	<div class="common-head">
                	...
                	<div class="fl">
						<a href="topic.php?act=add"><div class="fbutton"><div class="add" title="<?php echo $this->_var['lang']['add_topic']; ?>"><span><i class="icon icon-plus"></i><?php echo $this->_var['lang']['add_topic']; ?></span></div></div></a>
					</div>
                    <?php endif; ?>
                    <div class="refresh">
                    ...
                    <div class="search">
                        ...
                        <?php endif; ?>
                    	<div class="input">
                        	<input type="text" name="keywords" class="text nofocus" placeholder="<?php echo $this->_var['lang']['act_name']; ?>" autocomplete="off" />
...
?>
							    ...
							    <td class="handle">
									<div class="tDiv a5">
									  <a href="../topic.php?topic_id=<?php echo $this->_var['topic']['topic_id']; ?>&&preview=1" title="<?php echo $this->_var['lang']['view']; ?>" target="_blank" class="btn_see"><i class="sc_icon sc_icon_see"></i><?php echo $this->_var['lang']['view']; ?></a>
									  ...
									  <?php if ($this->_var['topic']['user_id'] == 0): ?><a href="topic.php?act=visual&topic_id=<?php echo $this->_var['topic']['topic_id']; ?>" target="_blank" class="btn_region"><i class="icon icon-edit"></i><?php echo $this->_var['lang']['renovation']; ?></a><?php endif; ?>
                                      <?php if ($this->_var['topic']['user_id'] == 0): ?><a href="../mobile/index.php?r=admin/editor&topic_id=<?php echo $this->_var['topic']['topic_id']; ?>" target="_blank" class="btn_region"><i class="icon icon-edit"></i><?php echo $this->_var['lang']['mobile_renovation']; ?></a><?php endif; ?>
									  <a href="javascript:;" title="<?php echo $this->_var['lang']['drop']; ?>" onclick="listTable.remove(<?php echo $this->_var['topic']['topic_id']; ?>,delete_topic_confirm,'delete');" class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['drop']; ?></a>
