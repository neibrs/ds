                        ...
                        <div class="stat_order_search">
                            ...
                            <div class="search_item">
                                ...
                                <form method="post" id="selectForm_2" name="selectForm_2">
                                    <!--<?php $_from = $this->_var['start_date_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'start_date_0_95061000_1555397353');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['start_date_0_95061000_1555397353']):
?>-->
                                    <?php if ($this->_var['k'] > 0): ?>
                                    <span class="bolang">&nbsp;&nbsp;+&nbsp;&nbsp;</span>
                                    <?php endif; ?>
                                    <div class="text_time" id="text_time_start">
                                        <input type="text" class="text" name="year_month[]" id="year_month_<?php echo $this->_var['k']; ?>" value="<?php echo $this->_var['start_date_0_95061000_1555397353']; ?>" autocomplete="off" readonly>
                                    </div>
